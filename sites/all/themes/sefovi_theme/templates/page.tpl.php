...
<div id="wrapper">
      ...
      <li>
        ...
        <div class="entry-container">
          <header class="entry-header">
            <h2 class="entry-title"><?php print $slide1_head; ?></h2>
          </header><!-- .entry-header -->
	    ...
	    <?php if($slide1_img != '') { ?>
            ...
            <?php } else { ?>
            <img src="<?php print base_path() . drupal_get_path('theme', 'sefovi_theme') . '/images/01.jpg'; ?>" class="slide-image" alt="<?php print $slide_alt; ?>" /></a>
        <?php } ?>
	<div class="clear"></div>
        </article>
      </li>
      ...
      <li>
		...
		<?php } else { ?>
            <img src="<?php print base_path() . drupal_get_path('theme', 'sefovi_theme') . '/images/02.jpg'; ?>" class="slide-image" alt="<?php print $slide2_alt; ?>"  /></a>
        	<?php } ?>
	<div class="clear"></div>
        </article>
      </li>
      ...
      <li>
        ...
        <div class="entry-container">
          <header class="entry-header">
            <h2 class="entry-title"><?php print $slide3_head; ?></h2>
          </header><!-- .entry-header -->
          <div class="entry-summary">
		...
		<?php } else { ?>
            <img src="<?php print base_path() . drupal_get_path('theme', 'sefovi_theme') . '/images/03.jpg'; ?>" class="slide-image" alt="<?php print $slide3_alt; ?>" /></a>
		<?php } ?>
         <div class="clear"></div>
        </article>
      </li>
  ...
  <div id="footer">
    ...
    <?php if (!theme_get_setting('copyright_override')){?>
      <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="http://sefovi.rs">Slovakia trading d.o.o.</a><?php print check_plain(theme_get_setting('copywrite_holder')) ?></p>
    <?php } else {?>
