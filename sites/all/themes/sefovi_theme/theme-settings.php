 ...
 *   The form state.
 */
function sefovi_theme_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['prof_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('Sefovi Theme Settings'),
    '#collapsible' => FALSE,
    '#collapsed' => FALSE,
  );
  ...
  $form['prof_settings']['slideshow']['slideimage'] = array(
    '#markup' => t('To change the Slide Images, Replace the slide-image-1.jpg, slide-image-2.jpg and slide-image-3.jpg in the images folder of the Sefovi theme folder.'),
  );
}
